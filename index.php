...
<head>
  ...
  <?php if ($store->get('favicon')): ?>
      <link rel="shortcut icon" href="assets/itsolution24/img/soft.png/<?php echo $store->get('favicon'); ?>">
  <?php else: ?>
...
<div class="hidden"><?php include('assets/itsolution24/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" value="softjacode@gmail.com" placeholder="Email / Phone No." name="username">
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="password" class="form-control" value="SoftJACOde" placeholder="Password" name="password">
          </div>
        </div>
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('', '', ''))) : ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://www.youtube.com/c/SoftJACode/">Mas proyectos aqui</a>, </p>
    </div>
  </section>
